...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VoteAnswer.voz'
        db.add_column(u'ask_voteanswer', 'voz',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'VoteQuestion.voz'
        db.add_column(u'ask_votequestion', 'voz',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VoteAnswer.voz'
        db.delete_column(u'ask_voteanswer', 'voz')

        # Deleting field 'VoteQuestion.voz'
        db.delete_column(u'ask_votequestion', 'voz')
    ...
    models = {
        ...
        u'ask.voteanswer': {
            ...
            'voz': ('django.db.models.fields.IntegerField', [], {'default': '2'})
        },
        u'ask.votequestion': {
