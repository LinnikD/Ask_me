...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VoteQuestion.vote'
        db.delete_column(u'ask_votequestion', 'vote')

        # Adding field 'VoteQuestion.vot'
        db.add_column(u'ask_votequestion', 'vot',
                      self.gf('django.db.models.fields.IntegerField')(default=33),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'VoteQuestion.vote'
        db.add_column(u'ask_votequestion', 'vote',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'VoteQuestion.vot'
        db.delete_column(u'ask_votequestion', 'vot')
    ...
    models = {
        ...
        u'ask.voteanswer': {
            ...
            'ans_id': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'autor_id': ('django.db.models.fields.IntegerField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'vot': ('django.db.models.fields.IntegerField', [], {'default': '22'})
        },
        u'ask.votequestion': {
            ...
            'vot': ('django.db.models.fields.IntegerField', [], {'default': '33'})
        },
        u'auth.group': {
