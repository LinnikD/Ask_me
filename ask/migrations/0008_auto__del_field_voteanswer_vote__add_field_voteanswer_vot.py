...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'VoteAnswer.vote'
        db.delete_column(u'ask_voteanswer', 'vote')

        # Adding field 'VoteAnswer.vot'
        db.add_column(u'ask_voteanswer', 'vot',
                      self.gf('django.db.models.fields.IntegerField')(default=22),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'VoteAnswer.vote'
        db.add_column(u'ask_voteanswer', 'vote',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'VoteAnswer.vot'
        db.delete_column(u'ask_voteanswer', 'vot')
